/**
 * @file Icon exports. Each icon renders inside a 24x24 viewBox with
 * a 1.75-stroke geometry, tuned to read well at the typography ramp's
 * `sm`–`lg` sizes against both light and dark backgrounds.
 *
